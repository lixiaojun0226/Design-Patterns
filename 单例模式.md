...
var singletonFather = singleton(fn.bind("John", "Doe", 50, "blue"))();
var singletonMother = singleton(fn.bind("Sally", "Rally", 48, "green"))();
...
+ "isOneInstanceWhenGetInstanceClosure: " + isOneInstanceWhenGetInstanceClosure + '<br>' + "isOneInstanceWhenGetSingleton: " + isOneInstanceWhenGetSingleton + '<br>'
...
+"singletonFather is: " +JSON.stringify(singletonFather); 
</script>
